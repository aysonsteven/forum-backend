...
$_sqlite_db->query("CREATE TABLE IF NOT EXISTS message ( idx INTEGER PRIMARY KEY, sender_id VARCHAR, recipient_id VARCHAR, subject VARCHAR, message VARCHAR, created VARCHAR);");
